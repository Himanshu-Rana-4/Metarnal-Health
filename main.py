...
maternal_model = pickle.load(open(r"C:\Users\HP\#Project\finalized_maternal_model.sav", 'rb'))
fetal_model = pickle.load(open(r"C:\Users\HP\#Project\fetal_health_classifier.sav", 'rb'))
